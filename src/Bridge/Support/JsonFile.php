 ...
 *
 * {@see \Bridge\Store} is this file with the bridges in it — which Discord
 * channel every connector is relaying with, across every server the bot is in.
 * Losing that silently is the worst thing the bot can do: a bridge that
 * disappears looks exactly like one that was never configured, and the person
 * who set it up is not watching the log.
 *
 ...
 *    truncated file plus one `link` command is every server's bridges gone with
 ...
 * is relaying everything else — so it goes through {@see Filesystem}, and the
